...
public class MybatisPlusGenerator {
    ...
    public static void main(String[] args) {
        ...
        config.setActiveRecord(true)//开启AR模式
                ...
                .setOutputDir("D:\\Users\\BloodFly\\git\\spring-stte\\spring-mybatis-plus\\src\\main\\java")
        ...
        strategyConfig.setCapitalMode(true)//开启全局大写命名
                ...
                .setInclude("book","book_stock");//逆向工程使用的表
        //4、包名策略配置
        PackageConfig packageConfig = new PackageConfig();
        packageConfig.setParent("com.stte.spring.smp")//设置包名的parent
                .setMapper("mapper")
                .setService("service")
